...
import { X, Users, UserPlus, Trash2, UserCheck, ChevronUp, ChevronDown, UserX, Search, FileText } from 'lucide-react';
...
export function DebugPanel() {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50 w-[800px] max-w-[calc(100vw-2rem)]">
